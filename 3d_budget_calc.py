...
if __name__ == "__main__":
    # 多零件测试数据
    parts = [
        {'name':'dn20jia_ju_1', 'volume':5149.716},
        {'name':'DN20m6-金属橡胶-1.step', 'volume':5319.901},
        {'name':'dn25_jia_ju_1', 'volume':4590.139},
        {'name':'DN25m6-金属橡胶-1.step', 'volume':5081.604},
        {'name':'dn32_jia_ju_1', 'volume':4941.514},
        {'name':'DN32m6-金属橡胶.step', 'volume':5299.408}
    ]
    
    result = calculate_multipart_cost(
        parts=parts,
        total_print_duration="0天4小时11分46秒"  # 合并打印总时长
    )
